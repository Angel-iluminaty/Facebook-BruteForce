...
if __name__ == "__main__":
    print("\033[92m---------- Bienvenido al Facebook BruteForce ----------\033[0m")
    print("\033[92m---------- Creado por: Angel Del Villar ----------\033[0m")
    ...
    email = input('ingrese Email/Nombre del usuario: ').strip()
